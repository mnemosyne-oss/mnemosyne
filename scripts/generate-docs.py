...
def _render_config(env_map, defaults, restart, version: str, effective=None) -> str:
    ...
    lines += [
        ...
        "row is written, so upgrading does not reweight rows already in the bank. Sleep output",
        "written before the upgrade keeps its original tier 1 and its original",
        "confidence-derived importance.",
        "",
        ...
        "UPDATE working_memory SET importance = 0.35 WHERE source = 'sleep_model_refresh_proposal';",
        "```",
        "",
