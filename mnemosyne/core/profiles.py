...
TEMPLATE_KEYS: List[str] = [
    ...
    "llm_n_ctx", "llm_timeout", "force_local", "disable_local_llm",
...
PROFILES: Dict[str, Dict[str, Any]] = {
    "minimal": {
        ...
        "settings": {
            ...
            "force_local": "0", "disable_local_llm": "false", "host_llm_enabled": "false", "host_llm_n_ctx": "4096",
    ...
    "speed": {
        ...
        "settings": {
            ...
            "force_local": "1", "disable_local_llm": "false", "host_llm_enabled": "false", "host_llm_n_ctx": "4096",
            "llm_conflict_detection": "false",
            "sync_encrypt": "false", "sync_roles": "user",
    ...
    "quality": {
        ...
        "settings": {
            ...
            "force_local": "0", "disable_local_llm": "false", "host_llm_enabled": "false", "host_llm_n_ctx": "64000",
    ...
    "research": {
        ...
        "settings": {
            ...
            "force_local": "0", "disable_local_llm": "false", "host_llm_enabled": "false", "host_llm_n_ctx": "32000",
            "llm_conflict_detection": "true",
            "sync_encrypt": "false", "sync_roles": "user,assistant",
            "auto_sleep_enabled": "true", "reflect_disabled_for_cron": "true",
            "reflect_max_calls_per_session": "5",
    ...
    "embedded": {
        ...
        "settings": {
            ...
            "force_local": "1", "disable_local_llm": "false", "host_llm_enabled": "false", "host_llm_n_ctx": "2048",
            "llm_conflict_detection": "false",
            "sync_encrypt": "false", "sync_roles": "user",
            "auto_sleep_enabled": "true", "reflect_disabled_for_cron": "true",
            "reflect_max_calls_per_session": "0",
