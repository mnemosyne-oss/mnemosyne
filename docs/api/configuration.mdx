...
There are **115 configuration keys**. A further
...
| `dream_active` | `MNEMOSYNE_DREAM_ACTIVE` | `false` | no | Whether Dream mode is active, disabling automated model-refresh mutations. |
